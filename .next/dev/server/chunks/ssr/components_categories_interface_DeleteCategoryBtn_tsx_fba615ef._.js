module.exports = [
"[project]/components/categories/interface/DeleteCategoryBtn.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DeleteCategoryBtn({ id }) {
    ...
    const handleDelete = async ()=>{
        try {
            setLoading(true);
            await __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$axios$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NodeApi"].delete(`${("TURBOPACK compile-time value", "http://localhost:8000")}/data/admin/category/delete/${id}`);
            setOpen(false);
            router.refresh();
        } catch (err) {
            console.error(err);
...
//# sourceMappingURL=components_categories_interface_DeleteCategoryBtn_tsx_fba615ef._.js.map
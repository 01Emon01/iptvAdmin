module.exports = [
"[project]/components/products/interface/ProductTableImage.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProductTableImage({ data }) {
    ...
    const myLoader = ({ src, width, quality })=>{
        return `${"TURBOPACK compile-time value", "http://localhost:8000"}/data/files/${src}?w=${width}&q=${quality || 50}`;
    };
...
"[project]/components/products/interface/DeleteProductButton.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DeleteProductButton({ id }) {
    ...
    const handleDelete = async ()=>{
        try {
            setLoading(true);
            await __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$axios$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NodeApi"].delete(`${("TURBOPACK compile-time value", "http://localhost:8000")}/data/admin/products/delete/${id}`);
            setOpen(false);
            router.refresh();
        } catch (err) {
            console.error(err);
...
//# sourceMappingURL=components_products_interface_86c4358f._.js.map
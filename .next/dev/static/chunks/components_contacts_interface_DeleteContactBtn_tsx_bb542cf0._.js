...
"[project]/components/contacts/interface/DeleteContactBtn.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DeleteContactBtn({ id }) {
    ...
    const handleDelete = async ()=>{
        try {
            setLoading(true);
            await __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$axios$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NodeApi"].delete(`${("TURBOPACK compile-time value", "http://localhost:8000")}/data/admin/contacts/delete/${id}`);
            setOpen(false);
            router.refresh();
        } catch (err) {
            console.error(err);
...
_s(DeleteContactBtn, "wRv52IYwtOlaPhTTbWay4iEgcG4=", false, function() {
    return [
...
_c = DeleteContactBtn;
var _c;
__turbopack_context__.k.register(_c, "DeleteContactBtn");
...
//# sourceMappingURL=components_contacts_interface_DeleteContactBtn_tsx_bb542cf0._.js.map